...
const commands = [
    {
      ...
      options: [
        {
          name: 'name',
          description: 'Update or add data for a specific Member (case-insensitive).',
          type: 3,
          required: true,
        },
        {
          name: 'profession_1',
          description: 'Your First Profession.',
          type: 3,
          required: false,
          choices: [
            { name: 'Alchemy', value: 'Alchemy' },
            { name: 'Animal Husbandry', value: 'Animal Husbandry' },
            { name: 'Arcane Engineering', value: 'Arcane Engineering' },
            { name: 'Armor Smithing', value: 'Armor Smithing' },
            ...
            { name: 'Jewel Cutting', value: 'Jewel Cutting' },
            { name: 'Leatherworking', value: 'Leatherworking' },
            { name: 'Lumber Milling', value: 'Lumber Milling' },
            { name: 'Lumberjacking', value: 'Lumberjacking' },
            { name: 'Metalworking', value: 'Metalworking' },
            { name: 'Mining', value: 'Mining' },
            { name: 'Scribing', value: 'Scribing' },
            { name: 'Stonemasonry', value: 'Stonemasonry' },
            { name: 'Tanning', value: 'Tanning' },
            { name: 'Tailoring', value: 'Tailoring' },
            { name: 'Weapon Smithing', value: 'Weapon Smithing' },
            { name: 'Weaving', value: 'Weaving' },
          ],
        },
        {
          name: 'level_1',
          description: 'Level of your Profession 1.',
          type: 3,
          required: false,
          choices: [
            { name: 'Novice', value: 'Novice' },
            { name: 'Apprentice', value: 'Apprentice' },
            { name: 'Journeyman', value: 'Journeyman' },
        ...
        {
          name: 'profession_2',
          description: 'Your Second Profession.',
          type: 3,
          required: false,
          choices: [
            { name: 'Alchemy', value: 'Alchemy' },
        ...
        {
          name: 'level_2',
          description: 'Level of your Profession 2.',
          type: 3,
          required: false,
          choices: [
            { name: 'Novice', value: 'Novice' },
        ...
        {
          name: 'profession_3',
          description: 'Your Third Profession.',
          type: 3,
          required: false,
          choices: [
            { name: 'Alchemy', value: 'Alchemy' },
        ...
        {
          name: 'level_3',
          description: 'Level of your Profession 3.',
          type: 3,
          required: false,
          choices: [
            { name: 'Novice', value: 'Novice' },
        ...
        {
          name: 'profession_4',
          description: 'Your Fourth Profession.',
          type: 3,
          required: false,
          choices: [
            { name: 'Alchemy', value: 'Alchemy' },
        ...
        {
          name: 'level_4',
          description: 'Level of your Profession 4.',
          type: 3,
          required: false,
          choices: [
            { name: 'Novice', value: 'Novice' },
        ...
        {
          name: 'profession_5',
          description: 'Your Fifth Profession.',
          type: 3,
          required: false,
          choices: [
            { name: 'Alchemy', value: 'Alchemy' },
        ...
        {
          name: 'level_5',
          description: 'Level of your Profession 5.',
          type: 3,
          required: false,
          choices: [
            { name: 'Novice', value: 'Novice' },
